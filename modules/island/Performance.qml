    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            Gauge {
                ...
                //
                // The denominator is the RAM in the machine, not MemTotal — see
                // Sys.nominalGib. Used stays exact.
                sub: Sys.memoryTotalKb > 0 ? `${Sys.gib(Sys.memoryUsedKb).toFixed(1)}/${Sys.nominalGib(Sys.memoryTotalKb)} GB` : ""
